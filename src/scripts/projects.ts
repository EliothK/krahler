...
export const PROJECTS: Project[] = [
    {
        ...
        figure: "~$90 → ~$9 / mo",
        figureAccent: "flux",
        figureLabel: "on Kubernetes versus now, from the Azure cost export; today's cost is almost all the Static Web Apps Standard plan",
        program: [
    ...
    },
    {
        ...
        figureAccent: "solar",
        figureLabel: "RMSE than the Open-Meteo weather forecast alone, 6 and 12 hours ahead, on a year of data the models never saw; the same in daylight hours only",
        program: [
    ...
    },
    {
        ...
        figure: "0.002% off",
        figureAccent: "flux",
        figureLabel: "typical error in k-eff on designs it never trained on, with the physics correction (the network alone: about 0.27% median); 25x faster than the exact solver; simple regression is off by about 4.6%",
        program: [
